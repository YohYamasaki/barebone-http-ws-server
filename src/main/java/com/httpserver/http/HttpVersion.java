...
public enum HttpVersion {
    ...
    private static final Pattern httpVersionReqgexPattern = Pattern.compile("^HTTP/(?<major>\\d+).(?<minor>\\d+)");
    ...
    public static HttpVersion getBestCompatibleVersion(String literalVersion) throws BadHttpVersionException {
        Matcher matcher = httpVersionReqgexPattern.matcher(literalVersion);
